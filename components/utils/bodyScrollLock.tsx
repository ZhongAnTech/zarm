...
export const lockBodyScroll = (targetElement: any, options?: BodyScrollOptions): void => {
  if (isIosDevice) {
    ...
    if (targetElement && !locks.some((lock) => lock.targetElement === targetElement)) {
      ...
      if (!documentListenerAdded) {
        Events.on(document, 'touchmove', preventDefault);
...
export const clearAllBodyScrollLocks = (): void => {
  if (isIosDevice) {
    ...
    if (documentListenerAdded) {
      Events.off(document, 'touchmove', preventDefault);
