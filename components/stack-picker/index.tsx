...
import React, { useEffect, MouseEvent, useState, ReactNode, useCallback, memo, useMemo } from 'react';
    ...
    const columnDataList = useMemo(() => {
      ...
      while (_dataSource) {
        ...
        const childrenData: typeof dataSource | undefined = (
          (colVal ? handleObtainItem(_dataSource, colVal[valueMember as keyof ReactNode]) : _dataSource[0]) || {}
        ).children;
            ...
            <div className={`${prefixCls}__wrapper`}>
              ...
              <div className={`${prefixCls}__group`}>
                {columnDataList.map((group, index) => {
                  const columnClass = classNames(`${prefixCls}__stack-column`, 'za-stack-picker-stack-column', {
