...
let defaultIconUrl = '//at.alicdn.com/t/font_1285036_9ze0vm44z57.js'; // generated by iconfont.cn

export function setDefaultIconUrl(url: string): void {
  defaultIconUrl = url;
}
...
class Icon extends PureComponent<IconProps, {}> {
  ...
  static setDefaultIconUrl = setDefaultIconUrl;
  ...
  render() {
    ...
    if (SvgComponent) {
      ...
      const MyIcon = Icon.createFromIconfont(defaultIconUrl);
      iconNode = (
        <MyIcon {...newProps} />
      );
    }
