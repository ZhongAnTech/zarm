      ...
      <Container className="input-page">
        ...
        <main>
          ...
          <Panel>
            ...
            <Panel.Body>
              <Cell title="数字"><Input type="number" placeholder="type is number" focused={this.state.focused} onFocus={value => console.log(`onFocus: ${value}`)} onBlur={value => console.log(`onBlur: ${value}`)} onClear={(value) => { console.log('清除了', value); }} /></Cell>
