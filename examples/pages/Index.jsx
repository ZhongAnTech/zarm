      ...
      <Container className="index-page">
        ...
        <main>
          <Panel titleRender="表单组件">
            ...
            <Cell hasArrow title="选择器 Picker & Select" onClick={() => history.push('/picker')} />
            <Cell hasArrow title="日期选择器 DatePicker & DateSelect" onClick={() => history.push('/datePicker')} />
          ...
          <Panel titleRender="数据展示">
            <Cell hasArrow title="折叠面板 Collapse" onClick={() => history.push('/collapse')} />
            ...
            <Cell hasArrow title="标签页 Tabs" onClick={() => history.push('/tabs')} />
          </Panel>
        </main>
        <Footer />
      </Container>
