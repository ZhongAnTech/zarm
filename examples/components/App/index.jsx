...
const LoadableComponent = (component) => {
  ...
  if (HAS_STYLE_COMPONENT.indexOf(component.name) > -1) {
    loader.style = () => import(`@examples/styles/pages/${component.name}Page`);
  }
...
class App extends Component {
  ...
  render() {
    ...
    return (
      ...
      // </TransitionGroup>
      <Switch key={location.pathname} location={location}>
        <Route exact path="/" component={LoadablePage(() => import('@examples/pages/Index'))} />
        {
        ...
        <Route component={LoadablePage(() => import('@examples/pages/NotFoundPage'))} />
      </Switch>
    );
  }
}
