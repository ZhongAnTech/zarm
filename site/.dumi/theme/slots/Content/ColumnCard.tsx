...
import { useLocale, useSiteToken } from '../../../hooks';
import JuejinLogo from './JuejinLogo';

const ANTD_IMG_URL = 'https://pic4.zhimg.com/v2-b74981913130b83cb90d5a4c9a696879_r.jpg';
...
const locales = {
  cn: {
    bigTitle: '文章被以下专栏收录：',
    zhiHu: '一个 UI 设计体系',
    yuQue: 'Zarm Design 官方专栏',
    junjin: 'Zarm Design 开源专栏',
    buttonText: '我有想法，去参与讨论',
  },
  en: {
    bigTitle: 'Articles are included in the column:',
    zhiHu: 'A UI design system',
    yuQue: 'Zarm Design official column',
    junjin: 'Zarm Design Open Source Column',
  ...
  return (
    <Card css={card} bordered={false}>
      ...
      {zhihuLink && (
        <div css={cardBody}>
          <div css={left}>
            <img src={ANTD_IMG_URL} alt="zarm" />
            <div>
              <p css={title}>Zarm Design</p>
              <div css={subTitle}>
