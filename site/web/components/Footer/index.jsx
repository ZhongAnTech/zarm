    ...
    return (
      <footer>
        ...
        <div className="group">
          <h2>帮助</h2>
          <ul>
            <li><a href="https://github.com/ZhonganTechENG/zarm">Github</a></li>
            <li><a href="/#/components/change-log">更新日志</a></li>
            <li><a href="https://github.com/ZhonganTechENG/zarm/issues">在线讨论</a></li>
            <li><a href="https://github.com/ZhonganTechENG/zarm/issues/new">报告 Bug</a></li>
          </ul>
        </div>
      </footer>
    );
