...
describe('PinchZoom', () => {
  ...
  describe('pinchZoom event', () => {
    ...
    it('touch event', async () => {
      ...
      fireEvent.touchStart(el!, { touches: [{ pageX: 35, pageY: 45 }, { pageX: 50, pageY: 60 }] });
      fireEvent.touchMove(el!, { touches: [{ pageX: 40, pageY: 60 }, { pageX: 60, pageY: 80 }] });
      fireEvent.touchMove(el!, { touches: [{ pageX: 120, pageY: 120 }, { pageX: 150, pageY: 160 }] });
      fireEvent.touchMove(el!, { touches: [{ pageX: 160, pageY: 180 }, { pageX: 180, pageY: 210 }] });
      fireEvent.touchMove(el!, { touches: [{ pageX: 200, pageY: 220 }, { pageX: 240, pageY: 250 }] });
      fireEvent.touchMove(el!, { touches: [{ pageX: 230, pageY: 260 }, { pageX: 280, pageY: 320 }] });
