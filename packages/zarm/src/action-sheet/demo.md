...
| 属性                                | 默认值                    | 说明               |
| :---------------------------------- | :------------------------ | :----------------- |
| --za-action-sheet-background        | '#fff'                    | 背景色             |
| --za-action-sheet-border-radius     | '14px'                    | 圆角大小           |
| --za-action-sheet-spacing-margin    | '8px'                     | 边距               |
| --za-action-sheet-item-height       | '56px'                    | 选项高度           |
| --za-action-sheet-item-font-size    | '20px'                    | 选项字体大小       |
| --za-action-sheet-item-font-weight  | 500                       | 选项字体粗细       |
| --za-action-sheet-item-text-color   | 'var(--za-theme-primary)' | 选项字体色         |
| --za-action-sheet-cancel-text-color | 'var(--za-theme-primary)' | 取消选项字体大小   |
| --za-action-sheet-cancel-margin-top | '8px'                     | 取消选项上边距大小 |
